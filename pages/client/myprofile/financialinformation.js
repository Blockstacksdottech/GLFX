                          ...
                          <form>
                            ...
                            <div className="mb-3">
                              <label className="mb-2">
                                ...
                                the risk involved in trading them, including the
                                possibility that I may lose all of my capital
                              </label>
                              <select
                                className="form-select"
                                name="assessment1"
                                value={capitalize(info.assessment1.toString())}
                                onChange={handleChange}
                              >
                                <option></option>
                                <option value="True">True</option>
                            ...
                            <div className="mb-3">
                              <label className="mb-2">
                                ...
                                and/or work experience in the financial services
                                industry
                              </label>
                              <select
                                className="form-select"
                                name="assessment2"
                                value={capitalize(info.assessment2.toString())}
                                onChange={handleChange}
                              >
                                <option></option>
                                <option value="True">True</option>
